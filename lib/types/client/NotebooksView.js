...
export function NotebooksView(api) {
    ...
    return (_jsxs("div", { className: css.shell, "data-conversation-composer-overlay": "", children: [_jsxs("header", { className: css.libraryHeader, children: [_jsxs("div", { children: [_jsx("p", { className: css.eyebrow, children: "NOTEBOOKS" }), _jsx("h2", { className: css.heading, children: "\u6211\u7684\u7B14\u8BB0" }), _jsx("p", { className: css.subtitle, children: "\u628A\u94FE\u63A5\u3001\u6587\u6863\u548C\u7075\u611F\u6574\u7406\u6210\u53EF\u8FFD\u95EE\u7684\u8D44\u6599\u5E93\u3002" })] }), _jsx("button", { className: css.primaryButton, type: "button", onClick: () => { setComposerOpen(true); }, children: "\uFF0B \u65B0\u5EFA\u7B14\u8BB0" })] }), _jsxs("div", { className: css.toolbar, children: [_jsx("div", { className: css.filters, "aria-label": "\u7B14\u8BB0\u7B5B\u9009", children: [['all', '全部'], ['manual', '我的笔记'], ['url', '网页资料'], ['document', '文档']].map(([id, label]) => _jsx("button", { className: filter === id ? css.activeChip : css.chip, type: "button", onClick: () => { setFilter(id); }, children: label }, id)) }), _jsxs("div", { className: css.toolbarActions, children: [_jsx("input", { className: css.search, value: query, onChange: event => { setQuery(event.target.value); }, onKeyDown: event => { if (event.key === 'Enter')
                                    void refresh(query); }, placeholder: "\u641C\u7D22\u7B14\u8BB0" }), _jsxs("select", { className: css.select, value: sort, onChange: event => { setSort(event.target.value); }, children: [_jsx("option", { value: "recent", children: "\u6700\u8FD1\u66F4\u65B0" }), _jsx("option", { value: "title", children: "\u6309\u6807\u9898" })] }), _jsx("button", { className: css.iconButton, type: "button", "aria-label": "\u7F51\u683C\u89C6\u56FE", "data-active": viewMode === 'grid', onClick: () => { setViewMode('grid'); }, children: "\u25A6" }), _jsx("button", { className: css.iconButton, type: "button", "aria-label": "\u5217\u8868\u89C6\u56FE", "data-active": viewMode === 'list', onClick: () => { setViewMode('list'); }, children: "\u2637" })] })] }), error === null ? null : _jsx("div", { className: css.error, role: "alert", children: error }), _jsx("section", { className: viewMode === 'grid' ? css.notebookGrid : css.notebookList, "aria-label": "\u7B14\u8BB0\u5217\u8868", children: visible.map((entry, index) => _jsx(NotebookCard, { entry: entry, index: index, list: viewMode === 'list', onOpen: () => { setSelected(entry); }, onDelete: () => { void api.delete(entry.id).then(() => refresh(query), cause => { setError(messageOf(cause)); }); } }, entry.id)) }), visible.length === 0 ? _jsx("button", { className: css.empty, type: "button", onClick: () => { setComposerOpen(true); }, children: "\u8FD8\u6CA1\u6709\u5339\u914D\u7684\u7B14\u8BB0\u3002\u521B\u5EFA\u7B2C\u4E00\u6761\u7B14\u8BB0\u3002" }) : null, composerOpen ? _jsx(NotebookComposer, { busy: busy, setBusy: setBusy, onClose: () => { setComposerOpen(false); }, onCreate: async (payload) => { const entry = await api.put(payload); setComposerOpen(false); await refresh(query); setSelected(entry); }, setError: setError }) : null] }));
}
...
function NotebookComposer({ busy, setBusy, onClose, onCreate, setError }) {
    ...
    return _jsx("div", { className: css.modalBackdrop, role: "presentation", children: _jsxs("form", { className: css.modal, onSubmit: submit, children: [_jsxs("div", { className: css.modalHeader, children: [_jsxs("div", { children: [_jsx("p", { className: css.eyebrow, children: "NEW NOTEBOOK" }), _jsx("h3", { children: "\u521B\u5EFA\u7B14\u8BB0" })] }), _jsx("button", { className: css.iconButton, type: "button", onClick: onClose, children: "\u00D7" })] }), _jsx("p", { className: css.hint, children: "\u5148\u5199\u4E00\u6BB5\u80CC\u666F\uFF0C\u521B\u5EFA\u540E\u53EF\u7EE7\u7EED\u6DFB\u52A0\u591A\u4E2A\u94FE\u63A5\u3001PDF\u3001\u6587\u6863\u6216\u804A\u5929\u56DE\u7B54\u3002" }), _jsx("input", { className: css.input, value: title, onChange: event => { setTitle(event.target.value); }, placeholder: "\u6807\u9898\uFF08\u53EF\u9009\uFF0C\u53EF\u542B emoji\uFF09" }), _jsx("textarea", { className: css.textarea, value: content, onChange: event => { setContent(event.target.value); }, placeholder: "\u5199\u4E0B\u80CC\u666F\u3001\u76EE\u6807\u6216\u7B2C\u4E00\u6761\u8D44\u6599\u2026" }), _jsx("input", { className: css.input, value: tags, onChange: event => { setTags(event.target.value); }, placeholder: "\u6807\u7B7E\uFF0C\u7528\u9017\u53F7\u5206\u9694" }), _jsxs("div", { className: css.modalFooter, children: [_jsx("button", { className: css.secondaryButton, type: "button", onClick: onClose, children: "\u53D6\u6D88" }), _jsx("button", { className: css.primaryButton, type: "submit", disabled: busy, children: busy ? '创建中…' : '创建笔记' })] })] }) });
}
